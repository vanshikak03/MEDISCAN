...
namespace UnityVolumeRendering
{
    ...
    public class VolumeRenderedObjectCustomInspector : Editor, IProgressView
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Render mode
            VolumeRenderedObject.RenderMode oldRenderMode = volrendObj.GetRenderMode();
            VolumeRenderedObject.RenderMode newRenderMode = (VolumeRenderedObject.RenderMode)EditorGUILayout.EnumPopup("Render mode", oldRenderMode);
            ...
            if (newRenderMode == VolumeRenderedObject.RenderMode.IsosurfaceRendering)
            {
            ...
            if (lightSettings)
            {
                if (volrendObj.GetRenderMode() == VolumeRenderedObject.RenderMode.DirectVolumeRendering)
                {
                ...
                if (volrendObj.GetLightingEnabled() || volrendObj.GetRenderMode() == VolumeRenderedObject.RenderMode.IsosurfaceRendering)
                {
