...
{
    /// <summary>
    /// Runtime (play mode) GUI for editing a volume's visualization.
    /// </summary>
    public class EditVolumeGUI : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (targetObject != null)
            {
                ...
                selectedRenderModeIndex = (int)targetObject.GetRenderMode(); // Initialize the selected index
            }
        }
        ...
        private void UpdateWindow(int windowID)
        {
            ...
            if (targetObject != null)
            {
                ...
                targetObject.SetRenderMode((VolumeRenderedObject.RenderMode)selectedRenderModeIndex);
