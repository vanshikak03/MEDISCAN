...
namespace UnityVolumeRendering
{
    ...
    public class VolumeRenderedObject : MonoBehaviour
    {
        ...
        public void SetRenderModeIsosurfaceRendering()
        {
            SetRenderMode(RenderMode.IsosurfaceRendering);
        }
        public void SetRenderModeMIP()
        {
            SetRenderMode(RenderMode.MaximumIntensityProjection);
        }
        public void SetRenderModeDirectVolumeRendering()
        {
            SetRenderMode(RenderMode.DirectVolumeRendering);
        }
        ...
        private void Awake()
        {
            // TODO: Remove this after some time. This is to avoid breaking old serialized objects from before volumeContainerObject was added.
